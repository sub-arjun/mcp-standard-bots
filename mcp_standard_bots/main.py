...
from .server import MCPStandardBotsServer
...
def main():
    ...
    parser.add_argument("--host", default="0.0.0.0", help="Host to bind to (HTTP/SSE modes only)")
    parser.add_argument("--port", type=int, default=8000, help="Port to bind to (HTTP/SSE modes only)")
